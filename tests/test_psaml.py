...
data = sqlContext.read.load('resources/iris.csv', format='com.databricks.spark.csv', header='false', inferSchema='true')
print('DATA:\n')
print(data)
...
testData = sqlContext.read.load('resources/iris_test_data.csv', format='com.databricks.spark.csv', header='false', inferSchema='true')
